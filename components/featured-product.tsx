    ...
    return (
        <section className="fp mt-5 md:mt-10 border-b-4 pb-10 mb-10">
            <div className="flex justify-between items-center py-4">
                <h2 className="font-bold text-2xl md:text-3xl max-w-md md:max-w-full">
                    {product?.name}
                </h2>
            ...
            <div className="pt-3 md:flex">
                <div>
                    <h4 className="font-bold mb-2 md:text-2xl mb-5">About the {product?.name}</h4>
                    <p className="capitalize hidden md:block">{product?.category}</p>
                    <p>{product?.description}</p>
                </div>
                <div className="md:w-2/5 md:ms-3">
                    <h4 className="font-bold text-xl mb-3 mt-5 md:mt-0 mb-5">People also buy</h4>
